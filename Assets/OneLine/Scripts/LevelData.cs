...
public class LevelData  {
	public static int totalLevelsPerWorld = 20;
	public static int prvLevelToCrossToUnLock = 20;
	public static int pressedWorld = 1;

	public static int worldSelected = 1;
    public static int levelSelected = 1;

    public static string[] worldNames = {"Level Pack 1", "Level Pack 2", "Level Pack 3", "Level Pack 4", "Level Pack 5", "Level Pack 6", "Level Pack 7", "Level Pack 8", "Level Pack 9", "Level Pack 10"};

	public static int[] hintGainForWorld = { };
